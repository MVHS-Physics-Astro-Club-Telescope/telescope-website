...
export const parts: Part[] = [
  ...
  },
  {
    ...
    estimatedCost: "$40–55",
    status: "Needed",
    notes: "6-pole / 3-pair truss matching the 3-segment UTA rings (was 8; stiffness margin verified 7×)",
