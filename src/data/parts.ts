...
export const parts: Part[] = [
  ...
  },
  {
    ...
    estimatedCost: "Donated",
    status: "Donated",
    notes: "via $500 fabrication credit",
    donatedBy: "SendCutSend",
  ...
  },
  {
    ...
    estimatedCost: "Donated",
    status: "Donated",
    notes: "via $500 fabrication credit; supports mirror without distortion",
    donatedBy: "SendCutSend",
  ...
  // ── Camera ──────────────────────────────────────────
  {
    name: "ToupTek Cooled DSO Camera",
    category: "Camera",
    specification: "Cooled CMOS deep-sky imager, USB 3.0",
    quantity: 1,
    estimatedCost: "Donated",
    status: "Donated",
    notes: "Primary deep-sky imaging camera — supersedes ZWO ASI662MC plan",
    donatedBy: "ToupTek Astro",
    purchaseUrl: "https://www.touptekastro.com",
  },
  {
    name: "Guide Camera",
    category: "Camera",
    specification: "ToupTek GPM462C 2.1MP color CMOS",
    quantity: 1,
    estimatedCost: "Donated",
    status: "Donated",
    notes: "Off-axis / guide-scope tracking camera",
    donatedBy: "ToupTek Astro",
    purchaseUrl: "https://www.touptekastro.com",
  },
  {
    name: "Electronic Auto-focuser",
    category: "Camera",
    specification: "ToupTek AAF motorized focuser",
    quantity: 1,
    estimatedCost: "Donated",
    status: "Donated",
    notes: "Replaces NEMA 17 focus stepper",
    donatedBy: "ToupTek Astro",
    purchaseUrl: "https://www.touptekastro.com",
  },
  {
