...
export const parts: Part[] = [
  ...
  },
  {
    ...
    estimatedCost: "$0",
    status: "Claimed",
    notes: "Not purchased — focus drive handled by the donated ToupTek AAF auto-focuser",
  ...
  },
  {
    ...
    estimatedCost: "$0",
    status: "Claimed",
    notes: "Not purchased — 5V derivation handled by the donated PPB Advance Gen 2 variable output",
  ...
  },
  {
    ...
    estimatedCost: "$0",
    status: "Claimed",
    notes: "Not purchased — distribution handled by the donated Pegasus PPB Advance Gen 2",
  ...
  },
  {
    ...
    estimatedCost: "$0",
    status: "Claimed",
    notes: "Not purchased — PWM handled by the donated PPB Advance Gen 2 dew heater outputs",
